      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 xl:px-8">
        <div className="mb-16 max-w-2xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center justify-center -space-x-px rounded-md border border-violet-100 bg-white p-1 shadow-sm">
            <span className="px-3 py-1 text-[10px] font-mono font-medium uppercase tracking-widest text-violet-600">Use Cases</span>
          </div>
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Where it helps <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-cyan-500">most</span>
          </h2>
          ...
          {USE_CASES.map((useCase, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="relative z-10 text-base font-bold text-slate-900 mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-cyan-600 transition-all">
                  {useCase.title}
                </h3>

                <ul className="relative z-10 space-y-2 text-sm leading-relaxed text-slate-500 group-hover:text-slate-700">
