...
export function HeroSection(_props: HeroSectionProps) {
  return (
    <div className="relative overflow-hidden rounded-xl bg-[linear-gradient(135deg,#3348b8_0%,#5b3cc8_100%)] p-6 text-white shadow-[0_12px_32px_-16px_rgba(51,72,184,0.35),inset_0_1px_0_rgba(255,255,255,0.08)] ring-1 ring-white/10 md:p-7" role="banner">
