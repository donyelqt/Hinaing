...
# Logic: Allow 8 parallel user streams, 8 concurrent ML model threads for faster sentiment analysis.
# Updated April 9, 2026: Increased ML from 4 to 8 for 47% faster sentiment processing.
...
_node4_ml_max_concurrency = max(1, int(os.getenv("NODE4_ML_MAX_CONCURRENCY", "8")))
